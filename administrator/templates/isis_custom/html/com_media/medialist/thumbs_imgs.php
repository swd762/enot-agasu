	...
	<li class="imgOutline thumbnail center">
		...
		<div class="imgThumb imgInput">
			...
			<label for="cb-image<?php echo $i ?>">
				<?php echo JHtml::_('image', COM_MEDIA_BASEURL . '/icons/img_icon.png', JText::sprintf('COM_MEDIA_IMAGE_TITLE', $this->escape($img->title), JHtml::_('number.bytes', $img->size)), array('width' => $img->width_60, 'height' => $img->height_60)); ?>
			</label>
		</div>
