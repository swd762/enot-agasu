...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $this->baseurl ?>templates/<?php echo $this->template ?>/addons/awesome/css/font-awesome.min.css">    <script type="text/javascript">
